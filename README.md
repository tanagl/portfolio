...
## Extended Minds
![Project Teaserimage](./images/ExtMinds3.png | width=100)
...
## Character realism
![Project Teaserimage](./images/Screenshot-Video.png | width=100)
...
![Project Teaserimage](./images/exp01-crop.png | width=100)
...
![Project Teaserimage](./images/3dui_teaser.png | width=100)
...
- Overview: This AR app scans for a business card and on recognition places a customized virtual avatar on the card.
- Technical Details: developend in Unity with a photorealistic avatar scan, to work on an Android tablet.
